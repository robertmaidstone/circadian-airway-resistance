...
png("plots_v3/EF50_AUC_bar_v3.png", width = 3000, height = 1500, res = 300)  # adjust size/res as needed
grid.draw(
  p_auc
)
...
png("plots_v3/EF50_max_bar.png", width = 3000, height = 1500, res = 300)  # adjust size/res as needed
grid.draw(
  p_max
)
grid.text( "WT", y = unit(0.03, "npc"),x = unit(0.175, "npc"), gp = gpar(fontsize = 12))
